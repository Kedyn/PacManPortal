...
class MenuScene(Scene):
    def __init__(self, director, background=(0, 0, 0)):
        ...
        self.logo = Text(text_rect, 140, director.regular_text_color, director.screen,
                         "PACMAN")
        ...
        self.play = Text(menu_rect, 50, director.regular_text_color, director.screen,
                         "PLAY GAME")

        menu_rect.y += 60

        self.high_score = Text(menu_rect, 50, director.regular_text_color, director.screen,
                               "HIGH SCORES")
